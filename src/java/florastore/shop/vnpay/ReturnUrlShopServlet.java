 ...
 * @author ADMIN
 */
@WebServlet(name = "ReturnUrlShopServlet", urlPatterns = {"/ReturnUrlShopServlet"})
public class ReturnUrlShopServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = MyAppConstants.ShopPlaceOrderFeatures.CHECKOUT_SUCCESS;
        ...
        if ("00".equals(vnp_ResponseCode)) {
            ...
            url = MyAppConstants.ShopPlaceOrderFeatures.CHECKOUT_FAIL;
