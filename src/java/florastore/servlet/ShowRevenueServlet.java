 ...
 * @author acer
 */
@WebServlet(name = "ShowRevenueServlet", urlPatterns = {"/ShowRevenueServlet"})
public class ShowRevenueServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = (String) siteMap.get(MyAppConstants.DashBoardFeatures.DASHBOARD_PAGE);
        try  {
            //1. Call DAO
            revenueDAO dao = new revenueDAO();
            //2. Call method
            dao.loadAmountByMonth(10,2024);
            //3. Get list
