 ...
 * @author acer
 */
@WebServlet(name = "WeeklyProductRevenueServlet", urlPatterns = {"/WeeklyProductRevenueServlet"})
public class WeeklyProductRevenueServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = (String) siteMap.get(MyAppConstants.DashBoardFeatures.WEEKLY_PRODUCT_PAGE);
        ...
        try {
            ...
            double monday = dao.loadProductTotalAmount(year, month, from, to, 2);
            double tuesday = dao.loadProductTotalAmount(year, month, from, to, 3);
            double wednesday = dao.loadProductTotalAmount(year, month, from, to, 4);
            double thursday = dao.loadProductTotalAmount(year, month, from, to, 5);
            double friday = dao.loadProductTotalAmount(year, month, from, to, 6);
            double saturday = dao.loadProductTotalAmount(year, month, from, to, 7);
            double sunday = dao.loadProductTotalAmount(year, month, from, to, 1);
            ...
            log("WeeklyProductRevenueServlet _ SQL: " + msg);
