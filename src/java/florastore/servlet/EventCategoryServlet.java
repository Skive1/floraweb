...
import florastore.event.EventCategoryDTO;
...
public class EventCategoryServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<EventCategoryDTO> categories = dao.getCategories();
            if (categories != null) {
            ...
            log("EventCategoryServlet _ SQL " + ex.getMessage());
        } catch (NamingException ex) {
            log("EventCategoryServlet _ Naming " + ex.getMessage());
        } finally {
