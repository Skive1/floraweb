...
public final class test_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <link rel=\"stylesheet\" href=\"css/css/font-awesome.min.css\">\n");
      out.write("        <!-- <link rel=\"stylesheet\" href=\"css/AdminLTE.css\"> -->\n");
      out.write("        <link rel=\"stylesheet\" href=\"css/css/_all-skins.min.css\">\n");
      out.write("        <link rel=\"stylesheet\" href=\"css/css/jquery-ui.css\">\n");
      out.write("        <link rel=\"stylesheet\" href=\"css/css/style.css\" />\n");
      out.write("        <link rel=\"stylesheet\" href=\"css/css/admincss.css\" />\n");
      out.write("        <link rel=\"stylesheet\" href=\"https://cdn.jsdelivr.net/npm/chart.js/dist/chart.min.css\">\n");
      ...
      out.write("                                    <li><a class=\"ri-arrow-right-s-fill\" href=\"dashBoard\">Theo tuần</a></li>\n");
      out.write("                                    <li><a class=\"ri-arrow-right-s-fill\" href=\"monthlyBoard\">Theo tháng</a></li>\n");
      out.write("                                </ul>\n");
      out.write("                            </li>\n");
      out.write("                            <li>\n");
      ...
      out.write("                                <ul class=\"sub-menu\">\n");
      out.write("                                    <li><a class=\"ri-arrow-right-s-fill\" href=\"productList.html\">Danh sách đơn hàng</a></li>\n");
      out.write("                                    <li><a class=\"ri-arrow-right-s-fill\" href=\"\">Delivery</a></li>\n");
      out.write("                                </ul>\n");
      out.write("                            </li>\n");
      out.write("                        </ul>\n");
      out.write("                    </div>\n");
      ...
      out.write("                            <ul class=\"flex-box\">\n");
      out.write("                                <li><i class=\"ri-notification-4-line\" number=\"3\"></i></li>\n");
      out.write("                                <li><i class=\"ri-message-2-line\" number=\"5\"></i></li>\n");
      ...
      out.write("                                    <p>Văn A<i class=\"ri-arrow-down-s-fill\"></i></p>\n");
      out.write("                                </li>\n");
      out.write("                            </ul>\n");
      out.write("                        </div>\n");
      out.write("                    </div> \n");
      ...
      if (_jspx_meth_c_if_1(_jspx_page_context))
        return;
      out.write("    \n");
      out.write("                        <h1 style=\"text-align: center;\">Dashboard</h1>\n");
      out.write("                        \n");
      out.write("                        <h3 class=\"mb-0 text-center\">\n");
      out.write("                            <strong>Revenue by month</strong>\n");
      out.write("                            <form id=\"f1\" method=\"get\" action=\"monthlyRevenue\">\n");
      out.write("                                <select name=\"year\" class=\"form-control\" id=\"dropdownYear\" style=\"width: 120px;\" onchange=\"getYear(this)\">\n");
      out.write("                                    ");
      ...
      out.write("                                </select>\n");
      out.write("\n");
      out.write("                                <select name=\"month\" class=\"form-control\" id=\"dropdownMonth\" style=\"width: 120px;\">\n");
      out.write("                                    <option value=\"\" selected=\"\" disabled=\"\">-- Select Month --</option>\n");
      out.write("                                    ");
      if (_jspx_meth_c_forEach_1(_jspx_page_context))
        return;
      out.write("\n");
      out.write("                                </select>\n");
      out.write("                                <button style=\"width: 100px; padding: 0\" class=\"form-control\" type=\"submit\">Submit</button>\n");
      out.write("                            </form>\n");
      out.write("                        </h3>\n");
      out.write("                        <div class=\"admin-content-main-chart\">\n");
      out.write("\n");
      out.write("                            <div class=\"admin-content-main-chart-line\">            \n");
      out.write("                                <canvas id=\"myChart\"></canvas>\n");
      out.write("                            </div>\n");
      out.write("                            <div class=\"admin-content-main-chart-bar-chart\">\n");
      ...
      out.write("                    data: [");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${requestScope.month1.total}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write(',');
      out.write(' ');
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${requestScope.month2.total}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write(',');
      out.write(' ');
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${requestScope.month3.total}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write(',');
      out.write(' ');
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${requestScope.month4.total}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write(',');
      out.write(' ');
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${requestScope.month5.total}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("\n");
      out.write("                        , ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${requestScope.month6.total}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write(',');
      out.write(' ');
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${requestScope.month7.total}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write(',');
      out.write(' ');
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${requestScope.month8.total}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write(',');
      out.write(' ');
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${requestScope.month9.total}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write(',');
      out.write(' ');
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${requestScope.month10.total}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("\n");
      out.write("                        , ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${requestScope.month11.total}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write(',');
      out.write(' ');
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${requestScope.month12.total}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("],\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${requestScope.pro1.productName}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("\", \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${requestScope.pro2.productName}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("\", \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${requestScope.pro3.productName}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("\", \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${requestScope.pro4.productName}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("\", \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${requestScope.pro5.productName}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("\"];\n");
      out.write("//    var xValues = [1, 2, 3, 4, 5];\n");
      out.write("    var yValues = [");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${requestScope.pro1.total}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write(',');
      out.write(' ');
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${requestScope.pro2.total}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write(',');
      out.write(' ');
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${requestScope.pro3.total}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write(',');
      out.write(' ');
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${requestScope.pro4.total}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write(',');
      out.write(' ');
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${requestScope.pro5.total}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("];\n");
      out.write("    var barColors = [\"red\", \"green\", \"blue\", \"orange\", \"brown\"];\n");
      out.write("\n");
      out.write("    new Chart(\"myBarChart\", {\n");
      out.write("        type: \"bar\",\n");
      out.write("        data: {\n");
      ...
      out.write("                text: \"TOP 5 Best Selling Product\"\n");
      out.write("            }\n");
      out.write("        }\n");
      out.write("    });\n");
      out.write("\n");
      out.write("    function getYear(obj) {\n");
      out.write("        var year = obj.value;\n");
  ...
  private boolean _jspx_meth_c_if_0(PageContext _jspx_page_context)
    ...
    _jspx_th_c_if_0.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${empty requestScope.MonthList}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
    int _jspx_eval_c_if_0 = _jspx_th_c_if_0.doStartTag();
    if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\n");
        out.write("                            <p>Không có sản phẩm được bán trong tháng này</p>\n");
        out.write("                        ");
  ...
  private boolean _jspx_meth_c_if_1(PageContext _jspx_page_context)
    ...
    _jspx_th_c_if_1.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${empty requestScope.allMonth}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
    int _jspx_eval_c_if_1 = _jspx_th_c_if_1.doStartTag();
    if (_jspx_eval_c_if_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\n");
        out.write("                            <p>Không có allMonth sản phẩm được bán trong tháng này</p>\n");
        out.write("                        ");
  ...
  private boolean _jspx_meth_c_set_0(PageContext _jspx_page_context)
    ...
    _jspx_th_c_set_0.setValue(new String("2024"));
  ...
  private boolean _jspx_meth_c_set_1(PageContext _jspx_page_context)
    ...
    _jspx_th_c_set_1.setVar("endYear");
    _jspx_th_c_set_1.setValue(new String("2018"));
  ...
  private boolean _jspx_meth_c_forEach_0(PageContext _jspx_page_context)
    ...
    _jspx_th_c_forEach_0.setVar("year");
    _jspx_th_c_forEach_0.setBegin(0);
    _jspx_th_c_forEach_0.setEnd(((java.lang.Integer) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${currentYear - endYear}", java.lang.Integer.class, (PageContext)_jspx_page_context, null)).intValue());
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${currentYear - year}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write('"');
          out.write('>');
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${currentYear - year}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("</option>\n");
