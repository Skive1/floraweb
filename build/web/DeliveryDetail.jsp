            ...
            <div class="row-grid">
                <div class="admin-sidebar">
                    ...
                    <div class="admin-sidebar-content">
                        <a><i class="ri-file-list-line"></i> Danh sách đơn hàng<i></i></a>
                    </div>
                </div>
                                ...
                                <table >
                                    ...
                                    <tbody style="height: 100px;">
                                                                ...
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <a class="btn btn-secondary" href="markAsDone?getEventOrderID=${eventOrder.eventOrderId}"
                                                                               style="background-color: green">Xác nhận</a>
                                        ...
                                        <c:if test="${empty event}">
                                            Hiện tại không có đơn hàng nào đã nhận
                                        </c:if>     
                                    </tbody>
                                </table>
                            </div>
