                                ...
                                <c:if test="${not empty event}">
                                    ...
                                    <div class="col-12" >
                                        <div class="d-flex justify-content-center mt-5">
                                            ...
                                            <c:if test="${sessionScope.currentPage != 1}"> 
                                                <form id="backForm" action="viewOrdersForDelivery" method="POST">
                                            ...
                                            <%--phần code laquo (<<) --%>
                                            <form id="paginationForm" action="viewOrdersForDelivery" method="POST">
                                            ...
                                            <c:if test="${sessionScope.currentPage != sessionScope.pageSize}"> 
                                                <form id="forwardForm" action="viewOrdersForDelivery" method="POST">
