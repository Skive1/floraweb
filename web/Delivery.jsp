            ...
            <div class="row-grid">
                <div class="admin-sidebar">
                    ...
                    <div class="admin-sidebar-content">
                        <a style="color: white"><i class="ri-file-list-line"></i> Danh sách đơn hàng<i></i></a>
                    </div>
                </div>
                            ...
                            <div class="admin-content-main-content-product-list">
                                <table >
                                    <c:if test="${requestScope.FoundError != null}">
                                        <a style="color: red">Đơn hàng đã được nhận bởi nhân viên khác!</a>
                                    </c:if>
                                    <thead>
                                    <th>No</th>
                                    <th>Tên người mua</th>
                                        ...
                                        <c:if test="${not empty event}">
                                            <c:forEach var="eventOrder" items="${requestScope.DELIVERY_LIST}" varStatus="counter">
                                                <tr>
                                                    ...
                                                    <td>                                                                     
                                                        <a class="delete-class" href="#" style="background-color: blue">X</a>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <c:if test="${eventOrder.status == 'Chờ giao' && eventOrder.deliveryStaffId == 0}">
                                                        <td>
                                                            <button type="button" class="btn btn-primary" data-toggle="modal" 
                                                                    data-target="#exampleModal" style="background-color: green">
                                                                Xác nhận
                                                            </button>
                                                                ...
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title" id="exampleModalLabel">Xác nhận nhận đơn hàng</h5>
