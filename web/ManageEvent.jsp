                ...
                <div class="admin-content">
                    <div class="admin-content-top">
                        ...
                        <div class="admin-content-top-right">
                            <ul class="flex-box">
                                <!--                                <li><i class="ri-notification-4-line" number="-"></i></li>
                                                                <li><i class="ri-message-2-line" number="-"></i></li>
                                                                <li class="flex-box">
...
<!--style="display: flex; padding-left: 0; list-style: none"-->
                            ...
                            <div class="admin-content-main-content-product-list">
                                        ...
                                        <c:if test="${not empty event}">
                                            <c:forEach var="eventList" items="${requestScope.Event_List}" varStatus="counter">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="javascript:void(0);" class="btn btn-primary" style="color: white; background-color: #007bff"
                                                                        ...
                                                                        <c:forEach var="eventList2" items="${requestScope.Flower_List}" varStatus="counter2">
                                                                            <c:if test="${eventList.eventId == eventList2.eventEventId}">
                                                                                <tr>
                                                                                    ...
                                                                                    <td>${eventList2.eventProductDetail}</td>
                                                                                    <td>
                                ...
                                <div class="col-12 d-flex">
                                    <div class="justify-content-center" 
                                         style="display: flex; padding-left: 0; margin: 20px 0; 
                                         border-radius: 4px; justify-content: center; list-style: none">
                                        <c:if test="${sessionScope.currentPage == 1}"> 
                                            <a href="#" class="btn btn-secondary" style="margin: 1px; 
                                               background-color: gray; color: white; pointer-events: none; opacity: 0.6;
                                               border-color: black; font-weight: bold; padding: 9px 15px 9px 15px; ">
                                                &laquo;
                                            </a>
                                        </c:if>
                                        <c:if test="${sessionScope.currentPage != 1}"> 
                                            <form id="backForm" action="viewEvent" method="POST">
                                                <input type="hidden" id="pageBack" name="pageBack"/>
                                                <a href="#" class="btn btn-secondary" 
                                                   style="margin: 1px; background-color: white; border-color: black; color: black; font-weight: bold; padding: 10px 16px 10px 16px"
                                        ...
                                        <form id="paginationForm" action="viewEvent" method="POST">
                                                ...
                                                <c:forEach var="i" begin="1" end="${sessionScope.pageSize}">
                                                    ...
                                                    <c:if test="${sessionScope.currentPage != i}">
                                                        <a href="#" class="btn btn-secondary" 
                                                           onclick="document.getElementById('pageNo').value = '${i}';
                                                                   document.getElementById('paginationForm').submit();
                                                                   return false;" style="margin: 0; background-color: white; border-color: black; color: black; padding: 9px 15px 9px 15px; 
                                                           font-weight: bold">${i}</a>
                                                    </c:if>
                                                </c:forEach>
                                            </c:if>
                                            <c:if test="${sessionScope.pageSize >= 5}">
                                                <c:if test="${sessionScope.currentPage == 1 || sessionScope.currentPage == 2}">
                                                    <c:forEach var="i" begin="1" end="5">
                                                        <c:if test="${sessionScope.currentPage == i}">
                                                            <a href="#" class="active btn btn-secondary" 
                                                               onclick="document.getElementById('pageNo').value = '${i}';
                                                                       document.getElementById('paginationForm').submit();
                                                                       return false;" style="margin: 0; background-color: #000066; border-color: black; color: white; padding: 9px 15px 9px 15px;
                                                               font-weight: bold">${i}</a>
                                                        </c:if>
                                                        <c:if test="${sessionScope.currentPage != i}">
                                                            <a href="#" class="btn btn-secondary" 
                                                    ...
                                                    <a href="#" class="btn btn-secondary" style="margin: 1px; border-color: black; font-weight: bold; padding: 9px 15px 9px 15px;
                                        ...
                                        <c:if test="${sessionScope.currentPage != sessionScope.pageSize}"> 
                                            <form id="forwardForm" action="viewEvent" method="POST">
                                                <input type="hidden" id="pageForward" name="pageForward"/>
                                                <a href="#" class="btn btn-secondary" 
                                                   style="margin: 1px; background-color: white; border-color: black; color: black; padding: 9px 15px 9px 15px;"
                        ...
                        <script>
                            document.getElementById("adminSidebar").style.height = "";
                        </script>
                    </div>
                </div>
            </div>
