<%-- 
    Document   : eventProductList
    Created on : Oct 23, 2024, 4:23:47 AM
    Author     : Admin
--%>
                        ...
                        <div class="admin-content-main-content">
                            ...
                            <div class="admin-content-main-content-product-list">
                                <table id="orderTable">
                                    ...
                                    <tbody>
                                        <c:forEach var="product" items="${sessionScope.EVENT_PRODUCTS}" varStatus="counter">
                                            <tr>
                                                <td>${counter.count}</td>
                                                <td><img src="${product.eventProductImg}" alt="${product.eventProductName}" style="width: 100px; height: auto;"></td>
