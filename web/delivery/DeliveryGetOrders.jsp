                ...
                <div class="admin-content">
                    ...
                    <div class="admin-content-main">
                        <div class="admin-content-main-title">
                            <h1 style="font-size: 36px">List of undelivered orders:</h1>
                        </div>
                        <div class="admin-content-main-content">
                            ...
                            <div class="admin-content-main-content-product-list">
                                                                ...
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title" id="exampleModalLabel${counter.count}">Confirm receiving</h5>
                                                                        ...
                                                                        <div class="modal-body">
                                                                            ...
                                                                            <a style="color: red; font-weight: bold">
                                                                                You cannot cancel after receiving
                                                                            </a>
                                                                        </div>
                                                                        <div class="modal-footer">
                                                                            <form id="getOrder${counter.count}" action="delivererGetOrder" method="POST">
                                                                                <input type="hidden" id="getEventOrderID" name="getEventOrderID" value="${eventOrder.eventOrderId}"/>
                                                                                <input type="hidden" id="getEventOrderAmount" name="getEventOrderAmount" value="${eventOrder.amount}"/>
                                ...
                                <c:if test="${empty event}">
                                    ...
                                    <a href="delivererOrders">reload page</a>
                                </c:if>
                            </div>
                        </div>
                    </div>
