<%-- 
    Document   : feedbackForSeller
    Created on : Oct 26, 2024, 4:33:01 AM
    Author     : ADMIN
--%>
                    ...
                    <div class="admin-content-main">
                        ...
                        <div class="admin-content-main-content">
                            ...
                            <div class="admin-content-main-content-product-list">
                                ...
                                <div class="clearfix">
                                    <div class="hint-text">Showing <b>${requestScope.FEEDBACK_PER_PAGE}</b> out of <b>${requestScope.TOTAL_FEEDBACK}</b> entries</div>
                                    <ul class="pagination">
                                        <c:choose>
                                            <c:when test="${currentPage > 1}">
                                                <c:url var="prevUrl" value="viewFeedbacks">
                                        ...
                                        <c:forEach begin="1" end="${requestScope.END_PAGE}" var="i">
                                            <c:url var="urlRewriting" value="viewFeedbacks">
                                        ...
                                        <c:choose>
                                            <c:when test="${currentPage < requestScope.END_PAGE}">
                                                <c:url var="nextUrl" value="viewFeedbacks">
                                                    <c:param name="page" value="${currentPage + 1}"/>
                                                </c:url>
