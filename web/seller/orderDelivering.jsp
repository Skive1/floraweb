                        ...
                        <div class="admin-content-main-content">
                            ...
                            <div class="admin-content-main-content-product-list">
                                ...
                                <c:if test="${not empty event}">
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <form id="getOrder${counter.count}" action="sellerCancelOrder" method="POST">
                                    ...
                                    <div class="col-12" >
                                        <div class="d-flex justify-content-center mt-5">
                                            ...
                                            <c:if test="${sessionScope.currentPage != 1}"> 
                                                <form id="backForm" action="sellerViewOrders" method="POST">
                                            ...
                                            <%--phần code laquo (<<) --%>
                                            <form id="paginationForm" action="sellerViewOrders" method="POST">
                                            ...
                                            <c:if test="${sessionScope.currentPage != sessionScope.pageSize}"> 
                                                <form id="forwardForm" action="sellerViewOrders" method="POST">
                                ...
                                <c:if test="${empty event}">
                                    ...
                                    <a href="sellerViewOrders">tải lại trang</a>
                                </c:if>
                            </div>
                        </div>
                    </div>
